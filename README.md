...
<!-- LITTLE EXTRAS (fold away the noise) -->
<details>
  <summary><b>more goodies</b></summary>

  - 🧰 **Extra pins** beyond GitHub’s 6 using the cards above  
  - 🏆 You can add GitHub trophies or achievements if you like flair  
  - ⚙️ Consider a weekly cron (GitHub Actions) to refresh dynamic svgs
